...
public class StaffHomeInstrumentedTest1 {
    ...
    @Test
    public void viewMap() {
        onView(withId(R.id.btViewMap)).perform(click());
    }

    @Test
    public void todaysTeams() {
        onView(withId(R.id.btTodaysTeams)).perform(click());
    }
