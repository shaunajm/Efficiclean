...
public class StaffLoginInstrumentedTest2 {
    ...
    public void login() {
        ...
        closeSoftKeyboard();
        onView(ViewMatchers.withId(R.id.etUsername)).perform(typeText("morans34"));
        closeSoftKeyboard();
        onView(ViewMatchers.withId(R.id.etPassword)).perform(typeText("abc123"));
        closeSoftKeyboard();
